...
const repeatMyParam = () => {
    //YOUR CODE HERE
    axios.get('http://localhost:3000/repeat/tents').then((res) => {
        console.log(res.data)
...
const letsQuery = () => {
    //YOUR CODE HERE
    axios.get('http://localhost:3000/query-test/?1').then((res) => {
                   console.log(res.data)
    })
    .catch(error => {
        console.log(error)
...
document.getElementById("query-button").addEventListener("click",letsQuery )
////////////////
//INTERMEDIATE//
////////////////
